...
(function (factory) {
    ...
    $h = {
        ...
        DEFAULT_PREVIEW: '<div class="file-preview-other">\n' +
            '<span class="{previewFileIconClass}">{previewFileIcon}</span>\n' + /*'<span class="file-preview-other-error ui red message">شما مجاز به آپلود نبستید شسی سی شسی شسی شسی </span>'+*/
        '</div>',
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                previewSettings: {
                    ...
                    html: { width: '319px', height: '240px'},
                    text: { width: '319px', height: '240px'},
                    office: { width: '319px', height: '240px'},
                    gdocs: { width: '319px', height: '240px'},
                    video: { width: '319px', height: '240px'},
                    audio: {width: '100%', height: '30px'},
                    flash: { width: '319px', height: '240px'},
                    object: { width: '319px', height: '240px'},
                    pdf: { width: '100%', height: '240px'},
                    other: { width: '319px', height: '240px'}
                },
                previewSettingsSmall: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: { width: '100%', height: '240px'},
                    text: { width: '100%', height: '240px'},
                    office: { width: '100%', height: '240px'},
                    gdocs: { width: '100%', height: '240px'},
                    video: {width: '100%', height: 'auto'},
                    audio: {width: '100%', height: '30px'},
                    flash: {width: '100%', height: 'auto'},
                    object: {width: '100%', height: 'auto'},
                    pdf: { width: '100%', height: '240px'},
                    other: { width: '100%', height: '240px'}
                },
                previewZoomSettings: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: vDefaultDim,
                ...
                fileActionSettings: {
                    ...
                    dragSettings: {},
                    indicatorNew: '<i class="fas fa-plus-square text-warning"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'kv-file-remove btn btn-sm btn-kv btn-default btn-outline-secondary fileinput-remove-button',
