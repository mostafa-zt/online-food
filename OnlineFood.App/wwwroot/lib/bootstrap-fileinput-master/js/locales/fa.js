...
(function ($) {
    ...
    $.fn.fileinputLocales['fa'] = {
        ...
        msgSizeTooSmall: 'فایل "{name}" خیلی کوچک است و باید از <b>{minSize} کیلوبایت بزرگتر باشد</b>.',
        msgSizeTooLarge: 'فایل "{name}" از حداکثر مجاز <b>{maxSize} کیلوبایت</b> بزرگتر است.',
        ...
        msgInvalidFileType: 'نوع فایل "{name}" معتبر نیست.</br> فقط "{types}" پشیبانی می‌شوند.',
        msgInvalidFileExtension: 'پسوند فایل "{name}" معتبر نیست.</br> فقط "{extensions}" پشتیبانی می‌شوند.',
        msgFileTypes: {
            'image': 'عکس',
            'html': 'اچ تا ام ال',
            'text': 'متن',
