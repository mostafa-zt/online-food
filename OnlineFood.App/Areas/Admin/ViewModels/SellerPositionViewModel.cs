...
{
    /// <summary>
    /// نوع/جایگاه کاربر رستوران
    /// </summary>
    public class SearchSellerPositionViewModel
    {
        /// <summary>
        /// نام جایگاه کاربری
        /// </summary>
        [Display(Name = "نام جایگاه کاربری")]
    ...
    public class CreateSellerPositionViewModel
    {
        /// <summary>
        /// نام جایگاه کاربری
        /// </summary>
    ...
    public class EditSellerPositionViewModel
    {
