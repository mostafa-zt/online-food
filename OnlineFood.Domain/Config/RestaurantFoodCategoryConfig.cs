   ...
   public class RestaurantFoodCategoryConfig  : IEntityTypeConfiguration<RestaurantFoodCategory>
    {
        public void Configure(EntityTypeBuilder<RestaurantFoodCategory> builder)
        {
            ...
            //builder.HasOne(x => x.RestaurantImage).WithMany().HasForeignKey(x => x.RestaurantImageId).OnDelete(DeleteBehavior.Cascade);
            ...
            builder.HasData(new List<RestaurantFoodCategory>() {
                              ...
                              { new RestaurantFoodCategory() { Title = "Dessert", ActivityStatus = Enum.ActivityStatus.Available , CreatorDateTime = DateTime.Now , Id=6  } },
                              ...
                              { new RestaurantFoodCategory() { Title = "Pasta",  ActivityStatus = Enum.ActivityStatus.Available , CreatorDateTime = DateTime.Now , Id=9  } },
